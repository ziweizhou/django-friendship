...
follower_created = Signal(providing_args=['follower','followee'])
follower_removed = Signal(providing_args=['follower','followee'])
following_created = Signal(providing_args=['follower','followee'])
following_removed = Signal(providing_args=['follower','followee'])
